        ...
        <div className="about-container">
          ...
          <div className="about-text">
            ...
            <p className="about-description">
              The AmaniLink Hub is a dynamic, community-powered digital platform designed to foster lasting
              peace through collective action. It brings together citizens, grassroots organizations, peace
              advocates, and decision-makers to collaborate in identifying, reporting, tracking, and resolving
              conflicts in real time. By leveraging innovative technologies such as interactive maps,
              anonymous reporting tools, and live dialogue forums, the platform ensures transparency,
              inclusivity, and timely intervention.
              <br />
              <br />
              ...
              community elder, NGO, or simply a concerned citizen, The Peace Building Hub empowers you to be
      ...
      <section id="features" className="features-section">
        <div className="container">
          ...
          <p className="section-subtitle">
            Everything communities need to prevent, report, and resolve conflicts effectively
          </p>
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <button className="btn btn-secondary" onClick={() => navigate('/dialogue')}>
                Join Discussion
              </button>
            </div>
            ...
            <div className="feature-card">
              ...
              <button className="btn btn-secondary" onClick={() => setShowSuccessModal(true)}>
                Read Stories
              </button>
            </div>
            ...
            <div className="feature-card">
              ...
              <button className="btn btn-secondary" onClick={() => setShowUSSDModal(true)}>
                Learn More
              </button>
            </div>
          </div>
